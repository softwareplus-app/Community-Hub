        ...
        <section id="about" className="pt-40 pb-20 lg:pt-56 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-xl text-muted-foreground mb-10 leading-relaxed">
              Meximies Inc. offers vibrant musical and exercise classes designed to bring the community together. Discover new passions, meet amazing people, and transform your daily routine.
            </motion.p>
        ...
        <section id="classes" className="py-24 bg-white/50 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg font-semibold text-primary">$150 per 45 min session</p>
            </div>
